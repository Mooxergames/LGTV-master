...
- **Restored to REAL original fast-working code from 3 weeks ago** - Reverted player.js, channel_operation.js, and home_operation.js to commit 9fe9535 (genuine stable version from 3 weeks ago before all recent modifications). This version had fast channel switching with no black screen delays. Also kept the home page route guard fix to prevent VOD preview from playing over live TV channels when navigating quickly.
