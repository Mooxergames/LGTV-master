...
- **Fixed Samsung TV zoom/preview display issue** - Resolved problem where preview screen would show incorrectly zoomed video on Samsung TVs by increasing setDisplayArea() timeout from 0ms to 100ms in zoomInOut function. This gives the browser time to apply CSS changes before Samsung's webapis.avplay.setDisplayRect() is called with new coordinates.
