...
- **Implemented 4K/8K UHD streaming optimization** - Added automatic 4K/8K detection and Samsung AVPlay configuration for both live TV channels and VOD/Series content. When content is detected as 4K or 8K (from channel/movie name), the player now automatically configures Samsung's SET_MODE_4K streaming property and ADAPTIVE_INFO with appropriate max resolution (3840x2160 for 4K, 7680x4320 for 8K). This ensures optimal streaming quality for UHD content on compatible Samsung Tizen TVs. Detection works for content containing keywords: 4K, UHD, 2160P, 8K in the title.
